...
class Player
{
	...
	Player(String n, String em, String no)
	{
		this.name=n;
		this.email=em;
		this.no=no;	
...
{
	String ins;
	REG(String n, String em, String no, String ins)
	{
		super(n,em,no);
		this.ins=ins;	
	}
    ...
    void regS()
    {
    	...
    	Player S=new Player(name,email,no);
        S.get();
